        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Thêm user</h6>
                    <form method="POST" id="add-user-form" action="{{ url('admin/user-create') }}">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <fieldset class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" checked name="gender" id="gridRadios1"
                                        value="male">
